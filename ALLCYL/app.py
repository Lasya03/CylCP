...
if optional_features:
    st.sidebar.markdown(f"**Note:** While training the {model_key} model, it was observed that the following features had minimal impact on the prediction. Therefore, their costs are not included in the predicted value. However, you can select 'No' for these features to use the predicted cost, and manually add their costs later if needed.")
